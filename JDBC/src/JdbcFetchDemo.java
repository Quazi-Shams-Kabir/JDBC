...
public class JdbcFetchDemo {
    public static void main(String[] args) throws Exception {
        ...
        // String query = "select sname from student where rollno =2"; // for particular column
        ...
        ResultSet rs = st.executeQuery(query); // execute the query , ResultSet is an interface to store data in tabular form
